...
async def handle_incoming_message(event):
    ...
    if "#push" in message_text:
        ...
        promt = (
            ...
            "Название акции без изменений и только на латинице без русских названий (если указана биржа через пробел, то название акции должно быть с биржей через разделитель точка, "
            "если биржа не указана, то ничего не менять), "
