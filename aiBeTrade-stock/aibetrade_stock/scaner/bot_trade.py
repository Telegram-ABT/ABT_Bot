...
def process_push_message(message_text):
    ...
    promt = (
        ...
        "Название акции: нужно найти по названию акции тикер и определить биржу на которой торгуется этот тикер. Вернуть название Тикера и Биржу через точку без пробелов, "
