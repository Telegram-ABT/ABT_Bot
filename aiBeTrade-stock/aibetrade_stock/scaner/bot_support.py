...
def handle_query(call):
    ...
    if button_id == "scaner_status":
        bot.send_message(
            ...
            "<b>Приветствуем вас в боте по формированию рассылок потенциальным клиентам!</b>\n\n"
            "Что умеет этот бот:\n\n"
            "Сканер собирает базу потенциальных клиентов из телеграм-каналов, которые добавляются вместе с их диалогами. "
            "После формирования базы, база отправляется в бот рассылки, который в свою очередь отправляет пользователю "
            "информацию о том, что он может стать клиентом компании или купить ваш продукт.\n"
        ...
        bot.send_message(
            ...
            "<b>push</b> - это сигнал от телеграм-бота подписки Бит-Коган\n\n"
            "<b>set_signal</b> - это сигнал формирования базы собственных сигналов на покупку или продажу акций. Принимается в формате "
            ...
            "<b>set_price</b> - это сигнал для проверки актуальных цен акции в портфеле у которых статус 'no_price'\n\n"
            "<b>set_new</b> - это сигнал для установки статуса сигнала в портфеле от 'setting' на 'new'\n\n"
            "<b>set_complete</b> - это сигнал для установки статуса сигнала в портфеле от 'complete' на 'new'\n\n"
            "<b>get_status</b> - это сигнал для обновления состояний портфелей от брокера\n\n"
            "<b>Список акций</b> - опция, которая выводит список всех акций в портфеле\n\n"
            "<b>Get status</b> - опция для обновления состояний портфелей от брокера\n\n"
            "<b>Аналитика</b> - опция для вывода аналитики по портфелям\n\n"
