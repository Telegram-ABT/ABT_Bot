...
def attempt_to_save_data():
    while True:
        try:
            ...
            print(f"Данные успешно записаны в MongoDB: {data}")
            ...
            print(f"Ошибка при записи в MongoDB: {e}. Перегенерация данных...")
...
def run_every_minute():
    if check_db_and_collection():  # Проверяем наличие базы данных и коллекции
        ...
        print("Ошибка: Убедитесь, что база данных и коллекция существуют.")
