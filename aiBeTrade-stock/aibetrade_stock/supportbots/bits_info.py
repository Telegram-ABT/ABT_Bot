...
def get_info_texts(lang='en'):
    info_texts_ru = {
            ...
            'payments': "<b>Взаиморасчеты и оплата услуг:</b>\n\nМы работаем по принципу Share Profit 💡 — зарабатываем только если зарабатываете вы! 💵\n\n<b>30%</b> от прибыли при депозите до <b>10K USD</b> 💼.\n\n<b>25%</b> от прибыли при депозите от <b>10K до 50K USD</b> 💰.\n\n<b>20%</b> от прибыли при депозите свыше <b>50K USD</b> 💎.\n\nВзаиморасчеты проводятся:\n\n раз в месяц, если депозит до 10К usdt,\n\n раз в 2 месяца, если депозит более 10К usdt.\n\nКомиссия переводится по указанным реквизитам 💳.\n\n<b>‼️ В случае, если комиссия сервиса не будет переведена за 5 дней после окончания расчетного периода, сервис будет автоматически отключен.</b>",
    ...
    info_texts_en = {
            ...
            'payments': "<b>Settlements and Payment for Services:</b>\n\nWe operate on a Share Profit principle 💡 — we earn only if you earn! 💵\n\n<b>30%</b> of profit for deposits up to <b>10K USD</b> 💼.\n\n<b>25%</b> of profit for deposits from <b>10K to 50K USD</b> 💰.\n\n<b>20%</b> of profit for deposits over <b>50K USD</b> 💎.\n\nSettlements are conducted:\n\n once a month if the deposit is up to 10K USDT,\n\n once every 2 months if the deposit is more than 10K USDT.\n\nThe commission is transferred to the specified details 💳.\n\n<b>‼️ In case the service commission is not transferred within 5 days after the end of the billing period, the service will be automatically disabled.</b>",
    ...
    info_texts_fr = {
            ...
            'payments': "<b>Règlement et paiement des services :</b>\n\nNous travaillons selon le principe du Share Profit 💡 — nous gagnons uniquement si vous gagnez ! 💵\n\n<b>30%</b> des bénéfices pour un dépôt jusqu'à <b>10K USD</b> 💼.\n\n<b>25%</b> des bénéfices pour un dépôt de <b>10K à 50K USD</b> 💰.\n\n<b>20%</b> des bénéfices pour un dépôt supérieur à <b>50K USD</b> 💎.\n\nLes règlements sont effectués :\n\n une fois par mois si le dépôt est jusqu'à 10K usdt,\n\n une fois tous les 2 mois si le dépôt est supérieur à 10K usdt.\n\nLa commission est transférée selon les coordonnées indiquées 💳.\n\n<b>‼️ En cas de non-transfert de la commission du service dans les 5 jours suivant la fin de la période de règlement, le service sera automatiquement désactivé.</b>",
    ...
    info_texts_de = {
            ...
            'payments': "<b>Abrechnungen und Zahlungsdienste:</b>\n\nWir arbeiten nach dem Share Profit-Prinzip 💡 — wir verdienen nur, wenn auch Sie verdienen! 💵\n\n<b>30%</b> vom Gewinn bei einer Einzahlung bis zu <b>10K USD</b> 💼.\n\n<b>25%</b> vom Gewinn bei einer Einzahlung von <b>10K bis 50K USD</b> 💰.\n\n<b>20%</b> vom Gewinn bei einer Einzahlung über <b>50K USD</b> 💎.\n\nAbrechnungen erfolgen:\n\n einmal im Monat, wenn die Einzahlung bis zu 10K USDT beträgt,\n\n alle 2 Monate, wenn die Einzahlung mehr als 10K USDT beträgt.\n\nDie Gebühr wird an die angegebenen Kontodaten überwiesen 💳.\n\n<b>‼️ Falls die Servicegebühr nicht innerhalb von 5 Tagen nach Ende des Abrechnungszeitraums überwiesen wird, wird der Service automatisch deaktiviert.</b>",
    ...
    info_texts_es = {
            ...
            'payments': "<b>Facturación y pago de servicios:</b>\n\n¡Trabajamos bajo el principio de Share Profit 💡 — ganamos solo si ustedes ganan! 💵\n\n<b>30%</b> de las ganancias con un depósito de hasta <b>10K USD</b> 💼.\n\n<b>25%</b> de las ganancias con un depósito de <b>10K a 50K USD</b> 💰.\n\n<b>20%</b> de las ganancias con un depósito superior a <b>50K USD</b> 💎.\n\nLa facturación se realiza:\n\n una vez al mes, si el depósito es de hasta 10K usdt,\n\n una vez cada 2 meses, si el depósito es superior a 10K usdt.\n\nLa comisión se transfiere a los datos bancarios indicados 💳.\n\n<b>‼️ En caso de que la comisión del servicio no sea transferida dentro de los 5 días posteriores al final del período de facturación, el servicio se desactivará automáticamente.</b>",
    ...
    info_texts_zh = {
            ...
            'payments': "<b>结算和服务付款：</b>\n\n我们按照分享利润的原则工作 💡 — 只有在您盈利的情况下我们才会盈利！💵\n\n<b>30%</b> 的利润当存款为 <b>10K USD</b> 以下 💼。\n\n<b>25%</b> 的利润当存款为 <b>10K 至 50K USD</b> 💰。\n\n<b>20%</b> 的利润当存款超过 <b>50K USD</b> 💎。\n\n结算进行如下：\n\n 如果存款在 10K usdt 以下，每月结算一次，\n\n 如果存款超过 10K usdt，每两个月结算一次。\n\n佣金将按指定账户转账 💳。\n\n<b>‼️ 如果服务佣金在结算期结束后 5 天内未转账，服务将自动断开连接。</b>",
